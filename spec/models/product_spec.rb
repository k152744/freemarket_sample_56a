...
describe Product do
  describe '#create' do
    ...
    it "is invalid without a big_category_id" do
     ...
     product.valid?
     expect(product.errors[:big_category_id]).to include("を入力してください")
    end
    ...
    it "is invalid without a middle_category_id" do
     ...
     product.valid?
     expect(product.errors[:middle_category_id]).to include("を入力してください")
    end
    ...
    it "is invalid without a small_category_id" do
     ...
     product.valid?
     expect(product.errors[:small_category_id]).to include("を入力してください")
    end
    ...
    it "is invalid without a delivary_fee_id" do
     ...
     product.valid?
     expect(product.errors[:delivary_fee_id]).to include("を入力してください")
    end
    ...
    it "is invalid without a delivary_way_id" do
     ...
     product.valid?
     expect(product.errors[:delivary_way_id]).to include("を入力してください")
    end
  
    it "is invalid without a delivary_day_id" do
     product = build(:product, delivary_day_id: nil)
     product.valid?
     expect(product.errors[:delivary_day_id]).to include("を入力してください")
    end
